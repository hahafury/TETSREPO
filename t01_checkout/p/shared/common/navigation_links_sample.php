...
<div class="links">
  <div class="desktop">
    <div class="wrapper">
      <div class="print <?php if($current === 'print') { echo 'current';} ?>"><a href="https://subscribe.theepochtimes.com/p/?page=epoch-sample">Print</a></div>
      <div class="divider"></div>
      <div class="digital <?php if($current === 'digital') { echo 'current';} ?>"><a href="https://subscribe.theepochtimes.com/p/?page=digitalsub-sample">Digital</a></div>
      <div class="divider"></div>
