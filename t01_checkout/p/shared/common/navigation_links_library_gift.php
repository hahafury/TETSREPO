<!-- Includes nav links for print gift, magazine gifts -->
...
<div class="links">
  <div class="desktop">
    <div class="print <?php if($current === 'print') { echo 'current';} ?>"><a href="https://subscribe.theepochtimes.com/p/?page=gift-library">Newspaper Gift</a></div>
    <div class="divider"></div>
    <div class="insight <?php if($current === 'insight') { echo 'current';} ?>"><a href="https://subscribe.theepochtimes.com/p/?page=insight-gift" target="_newtab">INSIGHT Gift</a></div>
    <div class="divider"></div>
    <div class="ae <?php if($current === 'ae') { echo 'current';} ?>"><a href="https://americanessence.net/gift" target="_newtab">American Essence Gift</a></div>
  </div>
  <div class="mobile">
